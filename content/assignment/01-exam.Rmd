...
This assignment is due to me by email by 8:00 PM Tuesday, April 20 by email as a PDF.

If appropriate, you must be able to talk with some familiarity about arguments put forth in our readings, when relevant (informally, as in “According to Coase...”). You do not need formal citations, but it should be clear when you are referencing the readings vs. your own thinking. (This is not relevant for all questions.)
