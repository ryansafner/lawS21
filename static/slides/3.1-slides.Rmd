...
- .hi-green[Example]: I am an aircraft manufacturer, you and I sign a contract
  ...
  - I expect it will cost me $250,000 to produce
]
]
]
...
- Price of materials goes up, raising my costs to $700,000
  - inefficient to build the plane
- Or raises my costs to $400,000
  - efficient to build the plane, but I no longer want to
- Another buyer could arrive and offer me $600,000
- I could break my leg, making it impossible for me to build
]
]
.pull-right[
.center[
...
- .hi[Breach of contract] is when promisor fails to keep a promise
...
.center[
Social benefit of breach $>$ social cost of breach $\implies$ efficient to .hi-purple[breach]

Social benefit of breach $<$ social cost of breach $\implies$ efficient to .hi-purple[perform]
]

- Social benefit of breach: .red[promisor] saves cost of performing

- Social cost of breach: .blue[promisee] loses benefit from promise
...
.center[
.red[Promisor]'s cost to perform $>$ .blue[promisee]'s benefit from performance $\implies$ efficient to .hi-purple[breach]

.red[Promisor]'s cost to perform $<$ .blue[promisee]'s benefit from performance $\implies$ efficient to .hi-purple[perform]
]
...
Incentives of .red[promisor] (what will actually happen):
...
.center[
.red[Promisor]'s cost to perform $>$ .blue[promisee]'s benefit from performance $\implies$ **efficient** to breach

.red[Promisor]'s cost to perform $>$ .red[promisor]'s liability from breach $\implies$ .red[Promisor] **will** breach
]

--

- If we set **liability from breach = .blue[promisee]'s benefit from performance**, then .red[promisor] will only breach when it is efficient
...
- My cost of building the plane changes, and I break the contract

- Expectation damages: I owe you $150,000 if I fail to deliver the plane
...
- Whenever my cost is below $500,000:
  ...
  - It's efficient for me to build the plane

- Whenever my cost is above than $500,000:
  - I'm better off breaking my promise and paying damages
  - It's efficient for me to not build the plane
]
]
.pull-right[
.center[
...
.pull-left[
.smallest[
- If I breach our contract, I impose a negative externality on you
  - You expected $150,000 payoff if I performed
  - so if I breach, you're $150,000 worse off

- If I have to pay you $150,000 damages if I breach, then .hi-purple[I internalize the externality]
  - Now my action no longer affects your payoff
  - You get the same surplus ($150,00) whether or not I build the plane
  - With externality internalized, I choose efficiently when deciding to perform or breach
]
]
...
- Instead of expectation damages, what if penalty for breach were different?

- Suppose no penalty
  - If costs rise to $400,000, I will breach
  - but it would be efficient to perform

- Suppose penalty is $1,000,000
  - If costs rise to $700,000, I will perform
  - but it would be efficient to breach
]
