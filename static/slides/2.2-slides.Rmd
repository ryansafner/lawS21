...
- Three important legal points about property rights:
  ...
  2. Owner is .hi[at liberty] to exercise rights over her property (law neither forbids nor obliges her to)
  3. Others are .hi[forbidden to interfere] with owner’s exercise of her rights
...
- .hi-turquoise[It does not matter who is _initially_ assigned a property right, our bargaining will reach the efficient result]!
...
> If .hi[transaction costs are low], with .hi[well-defined] and .hi[tradeable property rights], parties can bargain voluntarily to reach the efficient outcome. 
...
- .hi-green[Example]: I will pay you to acquire your car
...
- We don't need to resort to law for mutually-agreeable transactions (like the car exchange)

- What's more interesting are .hi[incompatible uses] of our property that give rise to conflict
  - One person's use of their own property causes an .hi-purple[externality] on another
...
- Settling the dispute will impose a cost on one party

- Origin of the problem is unclear property rights!
  - Who has right/responsibility over activity creating the externality? 
...
- U.S. law (at various times): “open range”/“fencing out” (rancher's rights)
  ...
  - Ranchers are not liable for damages done by herd<sup>.magenta[†]</sup>

.footnote[<sup>.magenta[†]</sup> Unless the farmer had a clear fence and the cattle broke through it.]
]
...
.smallest[
- .hi-turquoise[Which rule is more efficient?]

- Consider incentives to farmer and rancher under:
...
- Coase: .hi-purple[it doesn't matter which rule we use — both lead to efficient outcome!]
...
- Does the Manufacturer have the right to use own equipment as noisily as he wants?
...
- We said this is not true if there are **externalities** (or other types of market failure)
