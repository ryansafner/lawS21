...
.pull-left[
- English common law: .hi-purple[“closed range”/“fencing in” (farmer's rights)]
...
.pull-left[
- U.S. law (at various times): .hi-orange[“open range”/“fencing out” (rancher's rights)]
...
- Consider incentives to farmer & rancher under:
  1. .hi-orange[Open range (rancher's rights)]
  ...
  2. .hi-turquoise[Closed range (farmer's rights)]
...
- Under .hi-orange[rancher's rights], farmer will build fence or pay rancher to keep fewer cattle

- Under .hi-turquoise[farmer's rights], rancher can build a fence or pay farmer to build a fence
