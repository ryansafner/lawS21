...
Price remains $c=5$. Because consumers *under*estimate the riskiness of the product, the demand *more* than the efficient quantity $(q^{\star \star} of 45).
...
Price remains $c=5$. Because consumers *over*estimate the riskiness of the product, the demand *less* than the efficient quantity $(q^{\star \star} of 45).
...
ggplot(data = tibble(x = c(0,10)), aes(x = x))+
  ...
  geom_label(x = 12.5, y = demand_under(12.5), label = "D (under)", color = "darkblue")+
  geom_label(x = 12.5, y = demand_over(12.5), label = "D (over)", color = "darkblue")+
  #geom_function(fun = demand, geom = "line", size = 2, color = "blue")+
  geom_function(fun = supply, geom = "line", size = 2, color = "red")+
